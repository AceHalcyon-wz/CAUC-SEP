# CAUC-SEP 自旋电子器件实验平台技术文档 v3.4

<!--
文件名: CAUC-SEP_技术文档_v3.0.md
路径: docs/
功能: 完整技术文档，系统架构与开发指南
版本: v3.4
项目版本: v0.3.0
...
│   │   │   ├── __init__.py
│   │   │   ├── database.py                 # 数据库访问层
│   │   │   ├── data_storage.py             # 通用数据存储
│   │   │   ├── timeseries_storage.py       # 时序数据存储
│   │   │   └── data_pipeline.py            # 数据管道
│   │   │
│   │   ├── logging/                        # 日志模块
│   │   │   ├── __init__.py
│   │   │   ├── crash_report.py             # 崩溃日志生成
│   │   │   └── crash_upload.py             # 崩溃日志上传
│   │   │
│   │   └── monitoring/                     # 监控模块
│   │       ├── __init__.py
│   │       ├── profiler.py                 # 性能分析器
...
│
├── docs/                                   # 文档目录
│   ├── CAUC-SEP_技术文档_v3.0.md           # 技术文档
│   ├── DEVELOPER_GUIDE.md                  # 开发者指南
│   ├── USER_MANUAL.md                      # 用户手册
│   ├── NUITKA_BUILD_GUIDE.md               # Nuitka打包指南
│   ├── troubleshooting.md                  # 故障排除
│   └── DM2C-RS556_用户手册.md              # 设备手册
│
├── scripts/                                # 脚本目录
...
│   ├── docker-start.bat                    # Docker启动
│   ├── docker-stop.bat                     # Docker停止
│   ├── docker-build.bat                    # Docker构建
│   ├── docker-logs.bat                     # Docker日志
│   ├── lint-check.sh                       # 代码检查
│   └── run-tests.sh                        # 运行测试
│
