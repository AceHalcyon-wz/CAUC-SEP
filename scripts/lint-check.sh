...
# 文件名: lint-check.sh
# 路径: scripts/
# 功能: 运行所有代码检查工具（black, isort, ruff, mypy, eslint, prettier）
# 版本: v0.3.0
#
# 主要功能:
#   1. 后端代码检查（Python）
...
#
# 使用方法:
#   运行所有检查:     ./lint-check.sh
#   仅检查后端:     ./lint-check.sh -b
#   仅检查前端:     ./lint-check.sh -f
#   自动修复问题:   ./lint-check.sh -F
#   详细输出:       ./lint-check.sh -v
#
# 作者: 运维工程师 Agent
# 创建日期: 2024-03-01
# 最后更新: 2026-03-14
