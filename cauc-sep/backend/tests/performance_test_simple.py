...
def test_ring_buffer():
    ...
    print(f"  总耗时: {write_time:.2f} ms, 吞吐量: {iterations * len(data) / (write_time / 1000):.0f} 点/秒")
    ...
    print(f"  总耗时: {fast_write_time:.2f} ms, 提升: {(write_time - fast_write_time) / write_time * 100:.1f}%")
