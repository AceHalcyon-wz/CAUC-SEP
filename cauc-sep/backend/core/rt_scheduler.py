...
class SchedulerPerformanceMetrics:
    ...
    def get_report(self) -> dict[str, Any]:
        ...
        return {
            ...
            "executions_per_second": self.total_executions / uptime_seconds if uptime_seconds > 0 else 0,
            "execution_time": {
                "avg_ms": round(self.avg_execution_time_ms, 3),
                "max_ms": round(self.max_execution_time_ms, 3),
                "min_ms": round(self.min_execution_time_ms, 3) if self.min_execution_time_ms != float('inf') else 0,
            ...
            "reliability": {
                ...
                "miss_rate": self.missed_deadlines / self.total_executions if self.total_executions > 0 else 0,
...
class WinMMWrapper:
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            self._winmm.timeGetDevCaps.argtypes = [
                ctypes.POINTER(TIMECAPS),
                wintypes.UINT
            ]
    ...
    def get_min_resolution(self) -> int:
        ...
        caps = self._TIMECAPS()
        result = self._winmm.timeGetDevCaps(
            ctypes.byref(caps),
            wintypes.UINT(ctypes.sizeof(caps))
        )
...
class ThreadPriorityManager:
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            self._kernel32.SetThreadPriority.argtypes = [
                wintypes.HANDLE, wintypes.INT
            ]
            ...
            self._kernel32.SetPriorityClass.argtypes = [
...
class CPUAffinityManager:
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            self._kernel32.SetThreadAffinityMask.argtypes = [
                wintypes.HANDLE,
                wintypes.DWORD
            ]
            ...
            self._kernel32.GetSystemInfo.argtypes = [
...
class WindowsRTScheduler:
    ...
    def _cleanup_resources(self) -> None:
        ...
        # 恢复CPU亲和性
        if self._affinity_manager and self._original_affinity is not None and self._original_affinity > 0:
            try:
    ...
    def set_process_priority_high(self) -> bool:
        ...
        return self._priority_manager.set_process_priority_class(
