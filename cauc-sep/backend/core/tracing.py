...
class TracingMiddleware:
    ...
    async def __call__(self, scope, receive, send):
        ...
        try:
            ...
            trace.root_span.add_event("exception", {
                "type": type(e).__name__,
                "message": str(e),
            })
            raise
    ...
    def save_trace(self, trace: TraceContext) -> None:
        ...
        try:
            ...
            trace_record = self.TraceRecord(
                ...
                service_name=root_span.attributes.get("service.name", "unknown") if root_span else "unknown",
    ...
    def get_trace_detail(self, trace_id: str) -> Optional[dict[str, Any]]:
        ...
        try:
            ...
            return {
                ...
                "attributes": json.loads(trace_record.attributes) if trace_record.attributes else {},
                "spans": [
                    {
                        "span_id": s.span_id,
