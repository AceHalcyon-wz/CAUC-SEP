...
文件名: experiment.py
路径: backend/api/
功能: 实验管理API，提供实验创建、启动、停止、查询、导出等接口
作者: CAUC-SEP Team
创建日期: 2024-01-01
依赖: FastAPI, core.data_storage, core.tracing, api.schemas, middleware.security
...
API端点：
- POST /start: 开始实验
- POST /{exp_id}/stop: 停止实验
- GET /: 列出实验
- GET /{exp_id}: 获取实验详情
- GET /{exp_id}/export: 导出实验数据（CSV）
