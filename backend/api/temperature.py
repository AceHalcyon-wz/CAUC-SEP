...
文件名: temperature.py
路径: backend/api/
功能: 温控系统API，提供温度设定、PID配置、程序控温等接口
作者: CAUC-SEP Team
创建日期: 2024-01-01
依赖: FastAPI, core.temperature_controller, core.device_registry, api.schemas
...
API端点：
- GET /status: 获取温控系统状态
- POST /setpoint: 设置温度设定点
- GET /setpoint: 获取当前温度设定点
- POST /pid: 配置PID参数
- GET /pid: 获取当前PID参数
- POST /program: 启动程序控温
- POST /program/stop: 停止程序控温
- GET /program: 获取当前程序状态
- POST /protection: 配置温度保护
- GET /protection: 获取温度保护配置
- GET /history: 获取温度历史记录
- POST /history/clear: 清除温度历史记录
