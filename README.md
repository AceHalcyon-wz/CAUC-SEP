...
### 最新更新 (2026-03-25) - v4.0.0

- **CI/CD流水线**: 完整的GitHub Actions自动化流水线
  - 持续集成: 代码检查、测试、构建自动化
  - 自动发布: 版本验证、构建产物、GitHub Release
  - 测试覆盖率: 后端80%、前端70%
- **环境变量管理**: 统一的环境配置管理体系
  - 后端: Pydantic Settings + .env.production 生产配置
  - 前端: Vite环境变量 + 多环境配置
- **版本管理工具**: 自动化版本号同步脚本
  - 支持 pyproject.toml → package.json 自动同步
  - 支持 VERSION 文件生成
- **开发指南文档**: 完善的开发规范文档体系
  - 版本管理规范、依赖版本锁定策略、设备驱动开发指南
